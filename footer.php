		...
		<footer>
			<div class="container">
				<nav>
					<ul>
						<li><img src="<?php echo  get_stylesheet_directory_uri(); ?>/_app/images/logo-small.png" alt="<?php bloginfo('title'); ?>" /></li>
						...
						<li><a href="https://www.makespaceweb.com" title="Louisville Web Design" id="makespace-bee" target="_blank">
